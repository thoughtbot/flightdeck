...
| [aws_lambda_function.cloudwatch_alarm_sentry_notification](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_function) | resource |
...
| <a name="input_source_sns_topic_arn"></a> [source\_sns\_topic\_arn](#input\_source\_sns\_topic\_arn) | Source SNS topic for CloudWatch alarm messages. | `string` | n/a | yes |
<!-- END_TF_DOCS -->