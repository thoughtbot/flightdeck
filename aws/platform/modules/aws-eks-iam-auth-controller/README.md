...
This module installs the [AWS EKS IAM Auth Controller] which allows mappings for
the EKS aws-auth ConfigMap to be specified in multiple custom resources, rather
than patching a single ConfigMap.
...
| <a name="input_name"></a> [name](#input\_name) | Name for the Helm release | `string` | `"aws-eks-iam-auth-controller"` | no |
<!-- END_TF_DOCS -->
