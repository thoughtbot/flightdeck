...
|------|-------------|------|---------|:--------:|
| <a name="input_chart_name"></a> [chart\_name](#input\_chart\_name) | Helm chart to install | `string` | `"cluster-autoscaler"` | no |
| <a name="input_chart_repository"></a> [chart\_repository](#input\_chart\_repository) | Helm repository containing the chart | `string` | `"https://kubernetes.github.io/autoscaler"` | no |
...
| <a name="input_name"></a> [name](#input\_name) | Name for the Helm release | `string` | `"cluster-autoscaler"` | no |
