...
|------|-------------|------|---------|:--------:|
| <a name="input_chart_name"></a> [chart\_name](#input\_chart\_name) | Helm chart to install | `string` | `"cert-manager"` | no |
| <a name="input_chart_repository"></a> [chart\_repository](#input\_chart\_repository) | Helm repository containing the chart | `string` | `"https://charts.jetstack.io"` | no |
...
| <a name="input_name"></a> [name](#input\_name) | Name for the service account role | `string` | `"cert-manager"` | no |
